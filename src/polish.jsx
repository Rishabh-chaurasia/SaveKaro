...
export class ErrorBoundary extends Component {
  ...
  componentDidCatch(error, info) { console.error("SaveEarn Error:", error, info); }
  render() {
        ...
        {submitted ? (
          <div style={{ textAlign:"center",padding:"20px 0" }}>
            ...
            <p style={{ color:D.sub,fontSize:14,lineHeight:1.7,marginBottom:20 }}>
              Our team will review your deal within 24 hours. If approved, it'll be live on SaveEarn and you'll get credited +50 loyalty points!
            </p>
